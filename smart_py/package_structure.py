...
class PackageStructure:
    """A class that defines the structure of a Python package including directories and Docker image configuration."""
    def __init__(self, package_name, docker_image='python:3.9-slim'):
        """
Initialize a PackageBuilder object with the provided package name and optional Docker image.
